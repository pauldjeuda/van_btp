...
router.use('/public',            require('./publicConfig.router'));
...
router.use('/projects/:projectId/fixed-costs', require('./projectFixedCost.router'));
router.use('/projects/:projectId/quotes', require('./projectQuote.router'));
...
router.use('/equipment-requests', require('./equipmentRequest.router'));
router.use('/integrations/van-logistique', require('./vanLogistiqueIntegration.router'));
router.use('/stock',             require('./stock.router'));
router.use('/materials',         require('./material.router'));
...
router.use('/approvals',         require('./approvals.router'));
