...
const Project = sequelize.define('Project', {
  ...
  airRate: { type: DataTypes.STRING(100), allowNull: true },
  guaranteeRetention: { type: DataTypes.STRING(20), allowNull: true },
  guaranteeBank: { type: DataTypes.STRING(200), allowNull: true },
